...
class AppStore extends Component {
  state = {activeId: tabsList[0].tabId, search: ''}
  ...
  render() {
    ...
    const searchFilter = filtered.filter(each =>
    ...
    return (
      <div className="bg-container">
        ...
        <div className="div-border">
          <input onChange={this.onTyped} placeholder="search" type="search" />
